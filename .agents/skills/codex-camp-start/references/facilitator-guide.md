...
Use this when the user is running a class, workshop, or internal onboarding session.
...
- Normalize small outputs.
- Make blockers visible early: setup, permissions, accounts, API keys, MCP auth, and missing repo context.
- Ask learners to keep sensitive data out of screenshots.
- Keep success tied to artifacts, not polished demos.
