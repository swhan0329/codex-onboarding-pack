...
5. Facilitator mode: 수업/워크샵 진행안 만들기

답장 예시: `1`, `Start here`, `Explain simply`, `Daily workflow`, `Skill builder`
...
5. Facilitator mode: create a workshop run-of-show

Reply with: `1`, `start here`, `explain simply`, `daily workflow`, or `skill builder`.
...
- Facilitator mode -> read `facilitator-guide.md`
